...
const AdminHome = () => {
  ...
  const KPICard = ({ icon, value, label, delta, sparkline }) => (
    ...
    <div className="max-w-[1280px] mx-auto px-6 lg:px-6 py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="btn-secondary h-11 w-11 flex items-center justify-center">
        ...
        <div className="glass-card rounded-2xl border">
          ...
          <div className="divide-y divide-white/5">
            {recentActivity.map(activity => (
              <div key={activity.id} className="p-5 hover:bg-white/5 transition-colors h-14 flex items-center">
                <div className="grid grid-cols-[auto_2fr_1fr_1fr_auto] gap-4 w-full items-center">
                  <div className="flex items-center gap-3">
                  ...
                  <button className="text-cyan hover:text-white text-sm">{activity.action}</button>
                </div>
              </div>
            ))}
          </div>
