        ...
        return (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <button className="btn-primary h-10 px-4 text-sm">Add Track</button>
            </div>
              ...
              {tracks.map(track => (
                <div key={track.id} className="glass-card rounded-xl border p-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button className="text-error hover:text-white">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <button className="btn-secondary h-10 px-4 text-sm">Import CSV</button>
                    ...
                    <tr key={judge.id} className="border-b border-white/5 hover:bg-white/5 transition-colors h-14">
                      ...
                      <td className="px-5 py-3">
                        <div className="flex items-center gap-2">
                          <button className="text-cyan hover:text-white text-sm">Edit</button>
                          <button className="text-error hover:text-white text-sm">Revoke</button>
                        </div>
                      </td>
                    </tr>
                  ))}
        ...
        return (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <button className="btn-primary h-10 px-4 text-sm">Compose Announcement</button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button className="btn-secondary h-11 px-4">Regenerate</button>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="btn-secondary h-10 px-4 text-sm">Test Connection</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="max-w-[1280px] mx-auto px-6 lg:px-6 py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-text-muted text-sm mt-1">Configure hackathon settings and preferences</p>
        </div>
      </div>
