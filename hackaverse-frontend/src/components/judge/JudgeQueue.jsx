...
const JudgeQueue = () => {
  ...
  const statuses = ['all', 'pending', 'returned'];
  const sortOptions = [
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-6 lg:px-6 py-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-white">Judging Queue</h1>
          <p className="text-text-muted text-sm mt-1">{filteredSubmissions.length} submissions awaiting review</p>
        </div>
      </div>
