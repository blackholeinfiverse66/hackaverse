...
const GlobalSearch = ({ onFocus, onBlur, isFocused }) => {
  ...
  }, [onFocus, onBlur, isFocused, activeIndex]);
  ...
  return (
    <div className="relative flex-1 max-w-[640px]">
      ...
      {isFocused && (
        <div className="absolute top-full left-0 right-0 mt-2 w-full max-w-[640px] rounded-xl border border-white/10 bg-gunmetal backdrop-blur shadow-[0_10px_30px_-15px_rgba(0,0,0,.6)] z-[60] max-h-80 overflow-y-auto">
...
const NotificationsPopover = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="absolute top-full right-0 mt-2 w-[360px] rounded-xl border border-white/10 bg-white/[0.03] backdrop-blur shadow-[0_10px_30px_-15px_rgba(0,0,0,.6)] z-50">
...
const TopNav = ({ user, onLogout, sidebarWidth = 264 }) => {
  ...
  return (
    <header 
      className="fixed top-0 right-0 h-16 bg-[#0B1422]/80 backdrop-blur border-b border-white/10 z-20"
      ...
      <div className="h-16 grid grid-cols-[1fr_auto] items-center gap-4 px-6 xl:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            {userMenuOpen && (
              <div className="absolute top-full right-0 mt-2 w-48 rounded-xl border border-white/10 bg-white/[0.03] backdrop-blur shadow-[0_10px_30px_-15px_rgba(0,0,0,.6)] z-50">
                <div className="p-2">
