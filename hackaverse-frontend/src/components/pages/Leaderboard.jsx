  ...
  return (
    <div className="max-w-[1280px] mx-auto px-6 xl:px-8 py-8 text-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-white/70 mt-2">Track team rankings and performance</p>
      </div>
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{teams.reduce((sum, team) => sum + team.projects, 0)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-white/60">Top Score</span>
                <span className="font-medium">{teams[0]?.score.toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
