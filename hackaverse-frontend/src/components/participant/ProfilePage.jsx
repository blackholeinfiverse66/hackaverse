    ...
    <div className="max-w-[1280px] mx-auto px-6 lg:px-6 py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-text-muted text-sm mt-1">Manage your account information and preferences</p>
        </div>
        <button
      ...
      {hasChanges && isEditing && (
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-gray-900/95 backdrop-blur-sm border border-white/20 rounded-2xl p-4 flex items-center justify-between gap-4 shadow-xl z-50 min-w-[320px]">
