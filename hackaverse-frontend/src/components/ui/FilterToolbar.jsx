...
const FilterToolbar = ({
  ...
  const SelectDropdown = ({ filter }) => {
    ...
    return (
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute top-full left-0 right-0 mt-1 bg-bg-card border border-white/20 rounded-xl shadow-xl z-50 min-w-[220px] max-h-64 overflow-y-auto">
  ...
  return (
    <div 
      role="toolbar" 
      aria-label="Filters"
      className={`bg-white/[0.03] border border-white/10 rounded-xl p-3 ${className}`}
    >
