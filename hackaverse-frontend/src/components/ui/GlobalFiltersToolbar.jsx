...
const GlobalFiltersToolbar = ({ 
  ...
  }, [searchValue, selectedTracks, selectedStatus, selectedSort]);
  ...
  }, [searchValue, selectedTracks, selectedStatus, selectedSort, searchParams, sortOptions]);
    ...
    <>
      ...
      {isFilterSheetOpen && (
        <>
          ...
          ></div>
          <div className={`filter-sheet ${isFilterSheetOpen ? 'open' : ''}`}>
