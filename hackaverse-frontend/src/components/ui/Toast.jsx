...
const Toast = ({ message, type, onDismiss }) => {
  const typeStyles = {
    ...
    warning: 'bg-warning-yellow/20 border-warning-yellow text-warning-yellow',
  };

  return (
    <div className={`${typeStyles[type]} border rounded-xl p-4 mb-3 flex items-center justify-between animate-slide-in-right`}>
